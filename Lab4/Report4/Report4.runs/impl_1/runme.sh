...
HD_PWD='C:/Users/whofm/Documents/GitHub/DDCA_Lab_Files/Lab4/Report4/Report4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dimmer_fsm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dimmer_fsm.tcl -notrace
